...
import { Menu, UserStar, X } from "lucide-react"
...
export const Navbar = () => {
  ...
  return (
  <header className={`fixed top-0 right-0 left-0 transition-all duration-500 ${isScrolled ? "bg-transparent py-5" : "glass-strong py-3"}  z-50`}>
